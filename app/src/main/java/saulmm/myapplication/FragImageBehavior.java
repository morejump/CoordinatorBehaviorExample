...
/**
 * Created by morejump on 20/07/2017.
 */

public class FragImageBehavior extends  CoordinatorLayout.Behavior<ImageView> {
    ...
    public FragImageBehavior(Context context, AttributeSet attrs) {
        mContext = context;
